...
const API_URL = "https://some-random-api.com/canvas/overlay/glass";
...
module.exports = {
  name: "glass",
  description: "Apply a glass overlay to an image",
  category: "IMAGE",
  cooldown: 5,
  ...
  async messageRun(message, args) {
    ...
    const attachment = new AttachmentBuilder(buffer, { name: "glass.png" });
    const embed = EmbedUtils.embed()
      .setTitle("Glass Overlay")
