...
const API_URL = "https://some-random-api.com/canvas/overlay/gay";
...
module.exports = {
  name: "gay",
  description: "Apply a rainbow overlay to an image",
  category: "FUN",
  cooldown: 5,
  ...
  async messageRun(message, args) {
    ...
    const attachment = new AttachmentBuilder(buffer, { name: "gay.png" });
    const embed = EmbedUtils.embed()
      .setTitle("Gay Overlay")
