...
const API_URL = "https://some-random-api.com/canvas/filter/threshold";
...
module.exports = {
  ...
  async messageRun(message, args) {
    ...
    const attachment = new AttachmentBuilder(buffer, { name: "threshold.png" });
    const embed = EmbedUtils.embed()
      .setTitle("Threshold Filter")
      .setImage("attachment://threshold.png")
