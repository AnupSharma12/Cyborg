...
const API_URL = "https://some-random-api.com/canvas/filter/brighten";
...
module.exports = {
  ...
  async messageRun(message, args) {
    ...
    const attachment = new AttachmentBuilder(buffer, { name: "brighten.png" });
    const embed = EmbedUtils.embed()
      .setTitle("Brighten Filter")
      .setImage("attachment://brighten.png")
