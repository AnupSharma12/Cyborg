...
const API_URL = "https://some-random-api.com/canvas/misc/simpcard";
...
module.exports = {
  ...
  async messageRun(message, args) {
    ...
    const attachment = new AttachmentBuilder(buffer, { name: "simpcard.png" });
    const embed = EmbedUtils.embed()
      .setTitle("Simp Card")
      .setImage("attachment://simpcard.png")
