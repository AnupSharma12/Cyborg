...
const API_URL = "https://some-random-api.com/canvas/misc/lolice";
...
module.exports = {
  ...
  async messageRun(message, args) {
    ...
    const attachment = new AttachmentBuilder(buffer, { name: "lolice.png" });
    const embed = EmbedUtils.embed()
      .setTitle("Lolice Generator")
      .setImage("attachment://lolice.png")
