...
const API_URL = "https://some-random-api.com/canvas/misc/its-so-stupid";
...
module.exports = {
  ...
  async messageRun(message, args) {
    ...
    const attachment = new AttachmentBuilder(buffer, { name: "its-so-stupid.png" });
    const embed = EmbedUtils.embed()
      .setTitle("It's So Stupid")
      .setImage("attachment://its-so-stupid.png")
